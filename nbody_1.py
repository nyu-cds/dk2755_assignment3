...
"""
    N-body simulation.
    Optimization version: nbody_1.py
    In this version, the 'funcion call overhead' is reduced.
    This change decreased the execution time of the script from (92s) to (44s) 
    The version made the most improvement
"""
import timeit    
