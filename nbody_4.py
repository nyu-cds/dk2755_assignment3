...
"""
    N-body simulation.
    Optimization version: nbody_4.py
    In this version, used data aggregation to reduce loop overheads.
    This change decreased the execution time of the script from (92s) to (70.6s) 
    The version made the second most improvement
"""
import timeit    
import itertools
...
def report_energy(bodies_pair, e=0.0):
    '''
...
def nbody(loops, reference, iterations):
    ...
    for _ in range(loops):
        report_energy(bodies_pair)
        for _ in range(iterations):
            advance(0.01,bodies_pair)
        print(report_energy(bodies_pair))
