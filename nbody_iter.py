...
"""
    ...
    Enhanced the performance using the itertools: combinations, islice, count 
    The enhancement decreased the execution time by 1.6 seconds. 
"""
...
def advance(BODIES,dt,loops,iterations):
    ...
    # Get BODIES pair
    bodies_pair = list(combinations(BODIES.keys(), 2))
    
    for _ in islice(count(0),loops):
        for _ in islice(count(0),iterations):
