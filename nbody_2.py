...
"""
    N-body simulation.
    Optimization version: nbody_2.py
    In this version, used some alternatives to membership testing of lists.
    This change decreased the execution time of the script from (92s) to (87s)
    The version made the fourth most improvement
"""
import timeit    
